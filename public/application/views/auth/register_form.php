...
<div class="text-center">
	...
	<h2>
		...
		<br />
		Sign up with <?php if ($whitelabelinfo) {
							echo ucfirst($whitelabelinfo['name']);
						} else {
...
<form action="<?php echo base_url(); ?>auth/register" method="post" accept-charset="utf-8" style="
		margin-top:50px;
		margin-bottom:50px;
	" class="container">
	...
	<div class="col-md-6 text-center">
		<div class="panel panel-success">
			...
			<div class="panel-body">
				...
				<div class="form-group input-group-lg">
					<input type="submit" class="btn btn-lg btn-success btn-block" data-toggle="modal" data-target="#myModal" data-controls-modal="#myModal" data-backdrop="static" data-keyboard="false" value="Try Minical now!" name="register_submit_form" />
				</div>
			</div>
		</div>
