			...
			<div class="panel-body">
				<div class="form-inline hidden-print">
					<form method="get" action="<?php
						...
						<input type="checkbox" class="m-2" name="show_deleted" id="show_deleted" value="checked" <?php
		...
		<div class="table-responsive">
			...
			<table class="table table-hover">
				<tr>
					...
					<th><?php echo l('vehicle_number'); ?></th>

					<th class="text-left"><a href="<?php echo base_url() . "customer/set_order_by/last_check_in_date"; ?>"><?php echo l('check_in'); ?></a></th>

					<th class="text-right"><a href="<?php echo base_url() . "customer/set_order_by/last_check_out_date"; ?>"><?php echo l('check_out'); ?></a></th>
				...
				?>
					<tr class='customer-tr' name='<?php echo $r->customer_id; ?>'>
						...
						<td>
							<?php echo $r->vehicle_number; ?>
						</td>
						<td class='text-left' onclick="">
							<?php echo $r->last_check_in_date;  ?>
						</td>
						<td class='text-right' onclick="">
							<?php echo $r->last_check_out_date;  ?>
						</td>
						<!-- <td class='text-right' onclick="">
