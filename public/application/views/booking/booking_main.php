...
<div class="main-card mb-3 card m-33">
    <div class="card-body" style="padding: 1.2rem 1.2rem 1.2rem 1.2rem;">
        ...
        <div id="filter-rooms" class="row" style="padding-top: 0px; padding-bottom:10px;">
            <div class="col-sm-2 col-md-2 col-lg-1 col-xs-12 h4 text-right">
                <strong><?php echo l('filters'); ?></strong>
            </div>
            ...
            <div class="col-sm-2 col-md-2 col-lg-2 col-xs-12">
                <select name="room-floor" class="form-control col-sm-4 col-md-4 col-lg-4 col-xs-4" onchange="filter_data()">
                    ...
                    <option value='Clean'><?php echo l('Clean', true); ?></option>
                    <option value='Dirty'><?php echo l('Dirty', true); ?></option>
                    <option value='Inspected'><?php echo l('Inspected', true); ?></option>
                </select>
            </div>

            <div class="col-sm-2 col-md-1 col-lg-3 col-xs-12"></div>

            <div class="col-sm-3 col-md-3 col-lg-3 col-xs-12">
                <form id="booking_search" method="GET" class="input-group hidden-xs" action="http://localhost/public/booking/show_bookings/" style="margin-left:10px">
                    <input class="form-control" placeholder="Search Bookings" name="search_query" type="text" value="">
        ...
        <div id="rooms_container" class="rooms_container"><?php echo l('Loading', true); ?>...
...
<div class="modal fade" id="dialog-onhold-message" data-backdrop="static" data-keyboard="false">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="form-control" name="country" id="country">
                                            ...
                                            ?>
                                                <option data-country-code="<?= $country_code; ?>" value="<?php echo $country; ?>" <?php if ($info_by_ip && isset($info_by_ip->geoplugin_countryName) && $info_by_ip->geoplugin_countryName == $country) {
                                                                                                                                        echo 'selected';
                                                                                                                                    } elseif (!$info_by_ip && $country_code == 'US') {
                                                                                                                                        echo 'selected';
...
<div class="modal fade" id="confirm-blacklist-customer" data-backdrop="static" data-keyboard="false" style="z-index: 9999;">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
...
<div class="modal fade" id="reservation-message" data-backdrop="static" data-keyboard="false" style="z-index: 9999;">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
    ...
    <div class="modal" id="tutorial-video-modal" tabindex="-1" role="dialog" aria-labelledby="tutorial-video-modal" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <script src="https://fast.wistia.com/embed/medias/bkn09yxmrp.jsonp" async></script>
                <script src="https://fast.wistia.com/assets/external/E-v1.js" async></script>
                <div class="wistia_responsive_padding" style="padding:56.25% 0 0 0;position:relative;">
                    <div class="wistia_responsive_wrapper" style="height:100%;left:0;position:absolute;top:0;width:100%;">
                        <div class="wistia_embed wistia_async_bkn09yxmrp videoFoam=true autoPlay=true" style="height:100%;position:relative;width:100%">
                            <div class="wistia_swatch" style="height:100%;left:0;opacity:0;overflow:hidden;position:absolute;top:0;transition:opacity 200ms;width:100%;"><img src="https://fast.wistia.com/embed/medias/bkn09yxmrp/swatch" style="filter:blur(5px);height:100%;object-fit:contain;width:100%;" alt="" onload="this.parentNode.style.opacity=1;" /></div>
                        </div>
                    </div>
                </div>
            </div>
