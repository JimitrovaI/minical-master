...
<div class="footer hidden-print col-md-12">
    ...
    $time = time();
    $year = date("Y", $time);
    echo isset($whitelabelinfo['name']) && $whitelabelinfo['name'] ? $whitelabelinfo['name'] . " &copy; " . $year . " Motel Management System " : "Minical Inc." . " &copy; " . $year . "  ";
    ?>
</div>
        ...
        setInterval(function() {
            ...
            if (nonTranslatedKeys.length > 0) {
                ...
                $.ajax({
                    ...
                    data: {
                        non_translated_keys: nonTranslatedKeys
                    },
                    dataType: "json",
